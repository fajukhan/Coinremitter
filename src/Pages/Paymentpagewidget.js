    ...
    <>
        ...
        <Container>
          <Row className="align-items-center">
            ...
            <Col lg={6} md={12} className="mb-4 mb-lg-0">
              ...
              <a href="/signup">
              <button className="btn crypto-btn  text-white btn-lg fw-bold mt-3 clt3" style={{backgroundColor: '#00CEC9', borderColor: '#00CEC9', color: 'white'}}>
                CREATE NOW
              </button>
              </a>
            </Col>
      ...
      <section className="py-5 bg-light text-center">
        <Container>
          ...
          <h2 className="fw-bold text-dark mb-3 display-5">
            <span className="border-bottom border-3 d-inline-block pb-2" style={{borderColor: '#00CEC9'}}>Why Use</span> CoinRemitter's Payment Page
          </h2>
          ...
          <Row className="justify-content-center g-4">
            ...
            <Col lg={3} md={6} sm={12}>
              <div className="hexagon-wrap">
                ...
                <div className="hex-content">
                  <h3 className="fw-bold display-6" style={{color: '#00CEC9'}}>100%</h3>
            ...
            <Col lg={3} md={6} sm={12}>
              <div className="hexagon-wrap">
                ...
                <div className="hex-content">
                  <h3 className="fw-bold display-6" style={{color: '#00CEC9'}}>0%</h3>
                  <p>Chargeback Risk</p>
                </div>
              </div>
            </Col>
            ...
            <Col lg={3} md={6} sm={12}>
              <div className="hexagon-wrap">
                ...
                <div className="hex-content">
                  <h3 className="fw-bold display-6" style={{color: '#00CEC9'}}>50%</h3>
      ...
      <section className="py-5 bg-light text-center">
        <Container>
          ...
          <h2 className="fw-bold text-dark mb-5 display-5">
            <span className="border-bottom border-3 d-inline-block pb-2" style={{borderColor: '#00CEC9'}}>Key Features</span> Of CoinRemitter's Payment Page
          </h2>
          ...
          <Row className="g-4 mb-4">
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Page Style</h4>
            ...
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Goal Tracker</h4>
                <p className="text-dark">
            ...
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Price Fields</h4>
                <p className="text-dark">
          ...
          <Row className="g-4">
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Input Fields</h4>
                <p className="text-dark">
            ...
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Pay Button</h4>
                <p className="text-dark">
            ...
            <Col lg={4} md={6} sm={12}>
              <div className="feature-card p-4 h-100">
                <h4 className="fw-bold mb-3" style={{ color: "#00CEC9" }}>Additional Options</h4>
                <p className="text-dark">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 mb-5 mb-lg-0">
              <h2 className="display-5 fw-bold mb-4 text-dark">
                <span className="border-bottom border-3 d-inline-block pb-2" style={{borderColor: '#00CEC9'}}>Who Can Benefit</span> from the Payment Page?
              </h2>
              ...
              <a href="/signup">
              <button 
                className="btn btn-lg crypto-btn fw-bold px-5 my-3 border-0"
                style={{backgroundColor: '#00CEC9', color: 'white'}}
              >
                SIGN UP NOW
              </button>
              </a>
                    ...
                    <div className="card border-0 text-center bg-transparent">
                      <div className="card-body p-2">
                        <div className="p-4 mb-2 rounded" style={{backgroundColor: '#f8f9fa'}}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 60 60" fill="none">
                            <path d="M43.206 1.875C39.2354 1.875 36.7017 4.20961 35.2736 6.36398C33.6186 3.90234 30.8944 1.875 27.3118 1.875C21.9199 1.875 17.6953 6.65238 17.6953 12.4219C17.6953 19.3038 23.6827 22.4849 34.0204 31.4539L35.2734 32.4513L36.324 31.4539C46.6452 22.504 52.8241 19.0332 52.8241 12.4219C52.8241 6.65238 48.5995 1.875 43.206 1.875Z" fill="#00CEC9"></path>
                            <path d="M7.14844 37.0312H0V58.125H7.1484V37.0312Z" fill="#00CEC9"></path>
                            <path d="M50.4025 42.2695L42.1991 47.5781H22.9688V44.0625C23.4916 44.0625 38.2516 44.0625 38.7891 44.0625V37.0312C38.4107 37.0312 28.4662 37.0312 27.8203 37.0312C26.8358 37.0312 26.4492 36.3281 25.8164 35.871C23.5311 33.8319 20.6134 32.8125 17.6953 32.8125C15.6021 32.8125 13.1017 33.433 10.6641 34.9761V58.125H41.25L60 44.0625C57.8555 41.0391 53.6367 40.125 50.4025 42.2695Z" fill="#00CEC9"></path>
                          </svg>
                        </div>
                        ...
                        <div className="p-4 mb-2 rounded" style={{backgroundColor: '#f8f9fa'}}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 60 60" fill="none">
                            <g clipPath="url(#clip0_12638_975)">
                              <path d="M18.2446 36.4453H14.3848V30.4706C14.3848 28.5269 13.6089 26.7622 12.3518 25.4667C14.4987 24.0399 15.9174 21.6005 15.9174 18.8347C15.9174 14.4465 12.3473 10.876 7.95868 10.876C3.5701 10.876 0 14.4461 0 18.8347C0 21.2256 1.0611 23.3716 2.73514 24.8318C1.07071 26.1502 0 28.1868 0 30.4706V48.2666H11.7334V60H23.5547V41.7553C23.5547 38.8275 21.1725 36.4453 18.2446 36.4453Z" fill="#00CEC9"></path>
                              <path d="M57.2649 24.8318C58.9389 23.3716 60 21.2256 60 18.8347C60 14.4461 56.4299 10.876 52.0413 10.876C47.6527 10.876 44.0826 14.4461 44.0826 18.8347C44.0826 21.6 45.5013 24.0399 47.6482 25.4667C46.3911 26.7622 45.6152 28.5269 45.6152 30.4701V36.4453H41.7554C38.8275 36.4453 36.4453 38.8275 36.4453 41.7553V60H48.2666V48.2666H60V30.4706C60 28.1868 58.9293 26.1502 57.2649 24.8318Z" fill="#00CEC9"></path>
                              <path d="M41.25 14.2575V4.96078C41.25 2.22519 39.0248 0 36.2892 0H23.7108C20.9752 0 18.75 2.22519 18.75 4.96078V14.2575C18.75 16.9931 20.9752 19.2188 23.7108 19.2188H25.8403L30 26.4235L34.1597 19.2188H36.2892C39.0248 19.2188 41.25 16.9931 41.25 14.2575Z" fill="#00CEC9"></path>
                            </g>
                            <defs>
        ...
        <div className="container">
          <div className="row justify-content-between">
            ...
            <div className="col-lg-5 col-md-6 mb-5 mb-lg-0">
              <div>
                <h2 className="display-5 fw-bold mb-4 text-dark">
                  <span className="border-bottom border-3 d-inline-block pb-2" style={{borderColor: '#00CEC9'}}>
                ...
                <a href="/signup">
                <button 
                  className="btn btn-lg crypto-btn fw-bold border-0"
                  style={{backgroundColor: '#00CEC9', color: 'white'}}
                >
                  LEARN MORE
                </button>
                              ...
                              <div className="bg-light rounded p-3 d-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 72 73" fill="none">
                                  <g clipPath="url(#clip0_12630_787)">
                                    <path d="M0 17.375H72V0.5H0V17.375ZM50.7656 6.82812H63.4219V11.0469H50.7656V6.82812ZM25.4531 6.82812H29.6719V11.0469H25.4531V6.82812ZM17.0156 6.82812H21.2344V11.0469H17.0156V6.82812ZM8.57812 6.82812H12.7969V11.0469H8.57812V6.82812Z" fill="#00CEC9"></path>
                                    <path d="M52.5461 42.1053L49.5622 39.1208L33.4562 55.2268L31.4067 60.2613L36.4412 58.2118L52.5461 42.1053Z" fill="#00CEC9"></path>
                                    <path d="M12.7969 32.2812H29.6719V40.7188H12.7969V32.2812Z" fill="#00CEC9"></path>
                                    <path d="M58.5132 36.1376L55.5283 33.1548L52.5449 36.1381L55.5288 39.1226L58.5132 36.1376Z" fill="#00CEC9"></path>
                                    <path d="M0 72.5H72V21.5938H0V72.5ZM63.4219 66.0312H50.7656V61.8125H63.4219V66.0312ZM63.4219 57.5938H50.7656V53.375H63.4219V57.5938ZM64.4788 36.1375L38.4269 61.9564L23.7184 67.9489L30.1723 52.545L55.5282 27.1891L64.4788 36.1375ZM8.57812 28.0625H33.8906V44.9375H8.57812V28.0625ZM8.57812 53.375H21.2344V57.5938H8.57812V53.375ZM8.57812 61.8125H21.2344V66.0312H8.57812V61.8125Z" fill="#00CEC9"></path>
                                  </g>
                                </svg>
                              </div>
                            </div>
                        ...
                        <div className="p-4">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-4 text-center text-md-end mt-3 mt-md-0">
                              <div className="bg-light rounded p-3 d-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 72 73" fill="none">
                                  <path d="M12.6567 63.3574H59.343V67.3024H12.6567V63.3574Z" fill="#00CEC9"></path>
                                  <path d="M12.6567 36.7776H59.343V41.4188H12.6567V36.7776Z" fill="#00CEC9"></path>
                                  <path d="M18.5625 5.69775H72.0001V14.1358H18.5625V5.69775Z" fill="#00CEC9"></path>
                                  <path d="M0 67.3026H8.4381V59.1388H63.5619V67.3026H72V18.3547H0L0 67.3026ZM63.5619 45.6378H8.4381V32.559H63.5619V45.6378ZM8.43795 23.6991H36V27.9178H8.43795V23.6991ZM36 50.2788V54.4976H8.43795V50.2788H36Z" fill="#00CEC9"></path>
                                  <path d="M0 5.69775H14.3437V14.1358H0V5.69775Z" fill="#00CEC9"></path>
                                </svg>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="col-md-4 text-center text-md-end mt-3 mt-md-0">
                              <div className="bg-light rounded p-3 d-inline-block">
                                <svg width="40" height="40" viewBox="0 0 72 73" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect width="71" height="30" transform="translate(0.5 12)" fill="#00CEC9"></rect>
                                  ...
                                  <path d="M65 50.7096L44.014 32L44 59.6412L50.3683 53.7335L54.1086 62L59.9441 59.5181L56.2038 51.2516L65 50.7096Z" fill="#00CEC9" stroke="white" strokeWidth="2"></path>
                                </svg>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="p-4">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-4 text-center text-md-end mt-3 mt-md-0">
                              <div className="bg-light rounded p-3 d-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 72 73" fill="none">
                                  <path d="M44.8163 40.7188H0V49.1562H42.4688C42.4688 46.0691 43.3627 43.211 44.8163 40.7188Z" fill="#00CEC9"></path>
                                  <path d="M46.6875 49.1562C46.6875 56.1462 52.3538 61.8125 59.3438 61.8125C66.3337 61.8125 72 56.1462 72 49.1562C72 42.1663 66.3337 36.5 59.3438 36.5C52.3538 36.5 46.6875 42.1663 46.6875 49.1562ZM65.6719 47.0469V51.2656H61.4531V55.4844H57.2344V51.2656H53.0156V47.0469H57.2344V42.8281H61.4531V47.0469H65.6719Z" fill="#00CEC9"></path>
                                  <path d="M59.3438 32.2812C60.8089 32.2812 62.206 32.5279 63.5625 32.8805V11.1875H0V36.5H48.3007C51.2685 33.9073 55.1029 32.2812 59.3438 32.2812ZM21.2344 25.9531H8.57812V21.7344H21.2344V25.9531ZM31.7812 30.1719C28.2918 30.1719 25.4531 27.3332 25.4531 23.8438C25.4531 20.3543 28.2918 17.5156 31.7812 17.5156C35.2707 17.5156 38.1094 20.3543 38.1094 23.8438C38.1094 27.3332 35.2707 30.1719 31.7812 30.1719ZM42.4688 21.7344H55.125V25.9531H42.4688V21.7344Z" fill="#00CEC9"></path>
                                  <path d="M31.7812 25.9531C32.9462 25.9531 33.8906 25.0087 33.8906 23.8438C33.8906 22.6788 32.9462 21.7344 31.7812 21.7344C30.6163 21.7344 29.6719 22.6788 29.6719 23.8438C29.6719 25.0087 30.6163 25.9531 31.7812 25.9531Z" fill="#00CEC9"></path>
                                </svg>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="p-4">
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-4 text-center text-md-end mt-3 mt-md-0">
                              <div className="bg-light rounded p-3 d-inline-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 72 73" fill="none">
                                  <path d="M0 5H5.83594V11.8906H0V5Z" fill="#00CEC9"></path>
                                  <path d="M10.0547 5H15.8906V11.8906H10.0547V5Z" fill="#00CEC9"></path>
                                  <path d="M31.3546 37.4229L34.4718 34.3057C32.6837 32.5787 29.8165 32.2239 27.9423 34.0981L18.7247 43.3158C16.9818 45.0589 16.9818 47.8949 18.7247 49.6378L22.123 53.0361C23.8661 54.779 26.702 54.779 28.4449 53.0361L31.5623 49.9187C28.217 46.4934 27.8317 40.9459 31.3546 37.4229Z" fill="#00CEC9"></path>
                                  <path d="M20.1094 5H72V11.8906H20.1094V5Z" fill="#00CEC9"></path>
                                  <path d="M0 16.1094V68H72V16.1094H0ZM56.2586 43.8915L47.0409 53.1092C45.3998 54.7503 43.2177 55.6543 40.8968 55.6543C38.4899 55.6543 36.1976 54.6454 34.5452 52.9017L31.4279 56.0189C29.7342 57.7126 27.5086 58.5598 25.2838 58.5598C23.0584 58.5598 20.8339 57.7131 19.1398 56.0189L15.7414 52.6205C12.3536 49.2327 12.3536 43.7202 15.7414 40.3325L24.9591 31.1148C28.4444 27.6294 34.0484 27.9694 37.4548 31.3223L40.572 28.205C42.2132 26.5639 44.3952 25.6599 46.716 25.6599C49.0369 25.6599 51.219 26.5637 52.86 28.205L56.2583 31.6033C59.6462 34.9914 59.6462 40.5039 56.2586 43.8915Z" fill="#00CEC9"></path>
                                  <path d="M34.3374 46.728L34.5451 46.9357L37.6625 43.8185C39.5265 41.9543 39.2904 39.0507 37.4548 37.2888L34.3376 40.4061C32.5945 42.149 32.5945 44.9849 34.3374 46.728Z" fill="#00CEC9"></path>
                                  <path d="M49.877 31.1883C49.0326 30.344 47.9102 29.8789 46.716 29.8789C45.5218 29.8789 44.3992 30.344 43.5549 31.1883L40.4376 34.3055C43.7828 37.7307 44.1681 43.2782 40.6452 46.8013L37.5278 49.9185C39.3167 51.6461 42.1829 52.0002 44.0573 50.1261L53.275 40.9084C55.0179 39.1655 55.0179 36.3294 53.275 34.5865L49.877 31.1883Z" fill="#00CEC9"></path>
                                </svg>
                              </div>
                            </div>
                          </div>
      ...
      <section className="container py-5">
        ...
        <div className="faq-list">
          {faqs.map((item, index) => (
            <div className="faq-item" key={index} style={{borderColor: '#00CEC9'}}>
              <div
