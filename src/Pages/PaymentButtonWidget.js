...
import { FaPaintBrush, FaMoneyBillWave, FaWallet, FaEye } from 'react-icons/fa'; // FontAwesome icons
...
const features = [
  {
    icon: <FaPaintBrush size={40} color="#28a745" />,
...
const categories = [
  { label: 'Service Providers', icon: <FaTools size={28} color="#f5a200" /> },
  { label: 'Online Stores', icon: <FaStore size={28} color="#f5a200" /> },
  { label: 'Donation Platforms', icon: <FaDonate size={28} color="#f5a200" /> },
  { label: 'Content Creators', icon: <FaVideo size={28} color="#f5a200" /> },
  { label: 'Personal Trainers', icon: <FaDumbbell size={28} color="#f5a200" /> },
];
...
<section>
      ...
      <div className="row align-items-center">
        ...
        <div className="col-12 col-md-6  col-lg-6 mb-4 mb-md-0">
          <h1 style={{ color: 'black' }}>Add A Crypto Payment Button</h1>
            <span className="border-bottom border-3 border-warning pb-1 d-inline-block"></span>
          <p style={{ color: 'black' }}>
          ...
          <button className="btn crypto-btn btn-lg mt-5" style={{ backgroundColor: '#f5a200', color: 'black' }}>
            Create Now
          </button>
        </div>
...
<section className="py-5 bg-light text-center">
      <div className="container">
        <h2 className="display-5 fw-bold text-black mb-3">
          <span className="border-bottom border-3 border-warning d-inline-block pb-1">Why Use</span> CoinRemitter’s Payment Button
        </h2>
            ...
            <div key={index} className="col-12 col-sm-6 col-lg-3 mb-4 d-flex justify-content-center">
              <div className="position-relative" style={{ width: '260px' }}>
                ...
                <div className="position-absolute top-50 start-50 translate-middle text-center px-2">
                  <h3 className="text-warning fw-bold fs-3 mb-2">{item.title}</h3>
...
{/* SECTION-3 */}
 ...
 <section className="py-5 bg-light text-center">
      <div className="container">
        <h2 className="fw-bold text-black mb-5 display-6">
          <span className="border-bottom border-3 border-warning pb-1 d-inline-block">
        ...
        <a
          ...
          className="btn crypto-btn btn-lg mt-4 text-black fw-semibold"
        >
          Learn More
        </a>
      </div>
 ...
 <section className="py-5 bg-white text-center">
      <div className="container">
        ...
        <a
          href="https://merchant.coinremitter.com/signup"
          className="btn btn-warning text-black fw-semibold mt-4"
        >
          Sign Up Now
        </a>
      </div>
