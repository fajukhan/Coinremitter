         ...
         <div className="row justify-content-center">
           <div className="col-lg-8 col-md-10">
             ...
             <div className="d-flex justify-content-between align-items-center mb-5 position-relative">
               ...
               <div className="step-indicator d-flex flex-column align-items-center position-relative" style={{ zIndex: 2 }}>
                 <div className="rounded-circle d-flex align-items-center justify-content-center mb-2" 
                   style={{ width: '50px', height: '50px', backgroundColor: '#00CEC9', color: 'white', fontWeight: 'bold', fontSize: '1.2rem' }}>
                   <i className="fas fa-file-alt me-1"></i> 1
                 </div>
                 <span className="small">General Detail</span>
               </div>
             ...
             <div className="card shadow-sm border-0">
               <div className="card-header bg-white py-4 border-0">
                 <h4 className="card-title mb-0 text-center">
                   <i className="fas fa-info-circle me-2" style={{ color: '#00CEC9' }}></i>
                   General Detail
                 </h4>
               </div>
                 ...
                 <form onSubmit={handleSubmit}>
                   ...
                   <div className="mb-4">
                     <label htmlFor="coinName" className="form-label fw-semibold">
                       <i className="fas fa-coin me-2" style={{ color: '#00CEC9' }}></i>
                       Full Name Of Your Coin / Token
                       <span className="text-danger">*</span>
                     </label>
                     <div className="input-group">
                       <span className="input-group-text bg-light">
                         <i className="fas fa-signature" style={{ color: '#00CEC9' }}></i>
                       </span>
                       <input
                         type="text"
                   ...
                   <div className="mb-4">
                     <label htmlFor="tickerSymbol" className="form-label fw-semibold">
                       <i className="fas fa-hashtag me-2" style={{ color: '#00CEC9' }}></i>
                       Ticker / Symbol
                       <span className="text-danger">*</span>
                     </label>
                     <div className="input-group">
                       <span className="input-group-text bg-light">
                         <i className="fas fa-at" style={{ color: '#00CEC9' }}></i>
                       </span>
                       <input
                         type="text"
                         className="form-control"
                   ...
                   <div className="mb-4">
                     <label htmlFor="algorithm" className="form-label fw-semibold">
                       <i className="fas fa-project-diagram me-2" style={{ color: '#00CEC9' }}></i>
                       Algorithm
                       <span className="text-danger">*</span>
                     </label>
                     <div className="input-group">
                       <span className="input-group-text bg-light">
                         <i className="fas fa-brain" style={{ color: '#00CEC9' }}></i>
                       </span>
                       <select
                   ...
                   <div className="mb-4">
                     <label htmlFor="coinSupply" className="form-label fw-semibold">
                       <i className="fas fa-database me-2" style={{ color: '#00CEC9' }}></i>
                       Coin Supply
                       <span className="text-danger">*</span>
                     </label>
                     <div className="input-group">
                       <span className="input-group-text bg-light">
                         <i className="fas fa-coins" style={{ color: '#00CEC9' }}></i>
                       </span>
                       <input
                         type="number"
                         className="form-control"
                   ...
                   <div className="d-grid mt-5">
                     <button type="submit" className="btn btn-lg py-3 fw-semibold" style={{ backgroundColor: '#00CEC9', color: 'white', border: 'none', fontWeight:'500' }}>
             ...
             <div className="mt-4 p-3 bg-light rounded text-center">
               <p className="mb-0">
                 <i className="fas fa-lightbulb me-2" style={{ color: '#00CEC9' }}></i>
                 Need help? Check our <a href="#documentation" className="text-decoration-none" style={{ color: '#00CEC9' }}>documentation</a> or <a href="#support" className="text-decoration-none" style={{ color: '#00CEC9' }}>contact support</a>
               </p>
             </div>
           </div>
         </div>
